...
export const MAPS: MapInfo[] = [
  ...
  { name: 'Pearl',    displayName: 'パール',       imageUrl: 'https://media.valorant-api.com/maps/fd267378-4d1d-484f-ff52-77821ed10dc2/splash.png' },
  { name: 'Split',    displayName: 'スプリット',   imageUrl: 'https://media.valorant-api.com/maps/d960549e-485c-e861-8d71-aa9d1aed12a2/splash.png' },
  { name: 'Sunset',   displayName: 'サンセット',   imageUrl: 'https://media.valorant-api.com/maps/92584fbe-486a-b1b2-9faa-39b0f486b498/splash.png' },
];
